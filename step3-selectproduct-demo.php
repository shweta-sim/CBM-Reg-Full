...
<script src="step3-selectproduct/step3-selectproduct.js"></script>
<script>
...
function handleComplete(evt,comp) {
  ...
  exportRoot = new lib.step3selectproduct();
...
<body onload="init();" class="demo" id="step3-selectproduct">
<!-- ########## Wrapper Start ########## -->
<div class="wrapper"> 
      ...
      <div class="wrap-demovideo wrap-demovideo-inner">
        <div id="animation_container">
          ...
          <div class="button-bl text-center">
            ...
            <a href="step3-selectproduct-1.php" class="btn wow fadeInRight" data-wow-delay="200ms">Proceed With Registration</a>
          </div>
      </div>
  </div>
  <!-- ########## Page Content End ########## --> 
