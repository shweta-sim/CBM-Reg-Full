...
<script src="step1-st-registration/step1-st-registration.js"></script>
<script>
...
function handleComplete(evt,comp) {
  ...
  exportRoot = new lib.step1stregistration();
...
<body onload="init();" class="demo" id="step1-st-registration">
<!-- ########## Wrapper Start ########## -->
<div class="wrapper"> 
